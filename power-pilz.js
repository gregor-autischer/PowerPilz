 ...
 */
const ri = globalThis, fr = ri.ShadowRoot && (ri.ShadyCSS === void 0 || ri.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, gr = Symbol(), lo = /* @__PURE__ */ new WeakMap();
let Dn = class {
  constructor(e, i, r) {
    if (this._$cssResult$ = !0, r !== gr) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
...
}, co = fr ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((e) => {
  let i = "";
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), fo = /'/g, go = /"/g, Nn = /^(?:script|style|textarea|title)$/i, Ln = (t) => (e, ...i) => ({ _$litType$: t, strings: e, values: i }), y = Ln(1), be = Ln(2), rt = Symbol.for("lit-noChange"), E = Symbol.for("lit-nothing"), bo = /* @__PURE__ */ new WeakMap(), et = it.createTreeWalker(it, 129);
function Hn(t, e) {
...
const Ia = (t, e) => {
  ...
  for (let a = 0; a < i; a++) {
    const c = t[a];
    let d, u, h = -1, _ = 0;
    for (; _ < c.length && (s.lastIndex = _, u = s.exec(c), u !== null); ) _ = s.lastIndex, s === wt ? u[1] === "!--" ? s = mo : u[1] !== void 0 ? s = yo : u[2] !== void 0 ? (Nn.test(u[2]) && (o = RegExp("</" + u[2], "g")), s = Xe) : u[3] !== void 0 && (s = Xe) : s === Xe ? u[0] === ">" ? (s = o ?? wt, h = -1) : u[1] === void 0 ? h = -2 : (h = s.lastIndex - u[2].length, d = u[1], s = u[3] === void 0 ? Xe : u[3] === '"' ? go : fo) : s === go || s === fo ? s = Xe : s === mo || s === yo ? s = wt : (s = Xe, o = void 0);
    ...
    for (; (o = et.nextNode()) !== null && c.length < a; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith(On)) {
          ...
          c.push({ type: 1, index: n, name: m[2], strings: p, ctor: m[1] === "." ? Oa : m[1] === "?" ? Ra : m[1] === "@" ? Na : gi }), o.removeAttribute(h);
...
const Bn = "important", ja = " !" + Bn, M = Wa(class extends Ua {
...
}, ie = (t, e = "hybrid") => t === "history" || t === "statistics" || t === "hybrid" ? t : t === "auto" || e === "auto" ? "hybrid" : e, Fn = 3e4, Ka = 10 * 6e4, Ga = 1440, Xa = 1e4, Za = 2e3, Vn = 40, bi = /* @__PURE__ */ new Map(), Fi = /* @__PURE__ */ new Map(), Vi = /* @__PURE__ */ new Map(), vo = /* @__PURE__ */ new WeakMap(), wo = /* @__PURE__ */ new WeakMap(), xo = /* @__PURE__ */ new WeakMap(), So = /* @__PURE__ */ new WeakMap(), wr = (t, e = Ga) => {
  if (t.length <= e)
    return t;
  if (e <= 2)
  ...
  return u.forEach((_, p) => {
    const m = qa(_, i, o), g = e[p], f = m.entityId ?? g;
    f && (h[f] = m.points);
  }), e.forEach((_) => {
  ...
  const m = [...h].sort(), g = `${d}|${i}|${m.join(",")}`, f = Vi.get(g);
  if (f) {
    const b = await f;
    return p(b);
  }
  ...
  return o === "history" ? Xn(t, e, i, r == null ? void 0 : r.startMs) : o === "statistics" ? (await Zn(
    t,
    e,
    i,
  ...
  const d = () => {
    ...
    f.button === 0 && (i.stopPropagation && f.stopPropagation(), s = !1, u(), i.hasHold && (d(), r = setTimeout(() => {
  ...
  return t.addEventListener("pointerdown", h, { passive: !0 }), t.addEventListener("pointerup", _, { passive: !0 }), t.addEventListener("pointercancel", p, { passive: !0 }), t.addEventListener("pointerleave", p, { passive: !0 }), t.addEventListener("click", m), t.addEventListener("contextmenu", g), {
    destroy: () => {
      d(), u(), n !== void 0 && clearTimeout(n), t.removeEventListener("pointerdown", h), t.removeEventListener("pointerup", _), t.removeEventListener("pointercancel", p), t.removeEventListener("pointerleave", p), t.removeEventListener("click", m), t.removeEventListener("contextmenu", g), t.style.touchAction = c;
    }
  };
}, yt = (t) => {
  ...
  u.addColorStop(0, ft(i, o, s)), u.addColorStop(1, ft(i, n, s)), t.beginPath(), t.moveTo(a.x, a.y);
  for (let h = 1; h < e.length; h += 1)
  ...
  const i = e, r = [], o = (h) => {
    ...
    if (!_) return;
    const p = Je(i[h.labelKey]) ?? Mo(t, _) ?? _, m = Ui(i[h.trendColorKey], h.category, !1), g = sr(t, _) ?? "", f = {
      id: _,
      nodeKey: h.nodeKey,
      entityId: _,
      label: p,
  ...
  for (const h of xl)
    for (let _ = 1; _ <= h.count; _ += 1) {
      ...
      if (!m) continue;
      const g = Je(i[`${p}_label`]) ?? Mo(t, m) ?? m, f = Ui(void 0, h.category, !0), v = sr(t, m) ?? "", b = {
        id: m,
        nodeKey: p,
        entityId: m,
        label: g,
  ...
  for (const u of o) {
    let h = 0;
    for (const p of i) {
      const m = El(p.points, u), g = n.get(p.id) ?? 1;
      h += p.sign * m * g;
    }
    const _ = c > 0 ? h / c : h;
  ...
  const g = Math.max(1, e.endMs - e.startMs), f = { ctx: void 0 };
  ...
  for (let P = x.length - 1; P >= 0; P -= 1) {
    ...
    O.length >= 2 && ((e.mode === "single" || $ === 1) && nr(r, O, H, h, 0.24, 0, f), li(r, O, H, S)), z.push({
      id: D.id,
      label: D.label,
      resolvedColor: H,
      rawUnit: D.unit,
  ...
  for (const m of p) {
    const g = (m - e.min) / u, f = r + (1 - g) * o, v = n === "left" ? i - 6 : i + 6;
    t.fillText(Nl(m, s, c), v, f), n === "left" && (t.strokeStyle = Qn, t.lineWidth = 1, t.beginPath(), t.moveTo(i, f + 0.5), t.lineTo(i + (t.canvas.width - 1e-3), f + 0.5), t.stroke());
  }
  t.restore();
}, Io = (t, e, i, r, o, n) => {
  ...
  t.restore();
}, At = 3600 * 1e3, ge = 24 * At, ts = (t) => t <= 6 * At ? (e) => `${dt(e.getHours())}:${dt(e.getMinutes())}` : t <= 2 * ge ? (e) => `${dt(e.getHours())}:00` : t <= 200 * ge ? (e) => `${dt(e.getDate())}.${dt(e.getMonth() + 1)}` : (e) => `${dt(e.getMonth() + 1)}/${String(e.getFullYear()).slice(2)}`, Ol = (t) => t <= 6 * At ? At : t <= 2 * ge ? 6 * At : t <= 14 * ge ? ge : t <= 90 * ge ? 7 * ge : t <= 200 * ge ? 14 * ge : 30 * ge, Rl = (t, e) => {
  ...
  if (d.length < 2)
    return lr(t, r.innerLeft, r.innerTop, r.innerWidth, r.innerHeight, n), [];
  const u = c.map(
    (g) => d.map((f) => Math.max(0, is(g.points, f)))
  ), h = d.map((g, f) => {
    let v = 0;
    for (const b of u) v += b[f];
    return v;
  });
  ar(
    t,
  ...
  let _ = d.map((g) => ({
    x: Do(g, e.startMs, o, r.innerLeft, r.innerWidth),
    y: r.innerBottom
  }));
  const p = [], m = d.map(() => 0);
  for (let g = 0; g < c.length; g += 1) {
    const f = c[g], v = u[g], b = [], x = [];
    ...
    const k = Ie(i, f.color);
    yl(t, b, _, ft(k, 0.45, s)), li(t, b, k, e.lineWidth ?? 1.4), _ = b, p.push({
      id: f.id,
      label: f.label,
      resolvedColor: k,
      rawUnit: "%",
...
const Ze = (t, e = 2) => String(t).padStart(e, "0"), Vl = (t) => {
  const e = new Date(t), i = -e.getTimezoneOffset(), r = i >= 0 ? "+" : "-", o = Math.abs(i);
  return `${e.getFullYear()}-${Ze(e.getMonth() + 1)}-${Ze(e.getDate())}T${Ze(e.getHours())}:${Ze(e.getMinutes())}:${Ze(e.getSeconds())}${r}${Ze(Math.floor(o / 60))}:${Ze(o % 60)}`;
...
const dr = "power-pilz-energy-node-dialog", jt = [
  ...
  constructor() {
    super(...arguments), this.focusedNodeKey = "", this.overview = !1, this._allSeries = [], this._selectedIds = /* @__PURE__ */ new Set(), this._mode = "single", this._presetId = Zl, this._useCustomRange = !1, this._customStartIso = "", this._customEndIso = "", this._historyByEntity = /* @__PURE__ */ new Map(), this._loading = !1, this._openPopover = null, this._focusedEntityIdOverride = null, this._fetchAbort = 0, this._chartContext = null, this._canvasLogicalSize = { width: 0, height: 0 }, this._onDocumentMouseDown = (e) => {
  ...
  // ------------------------------------------------------------
  connectedCallback() {
    if (super.connectedCallback(), this._allSeries = Yn(this.hass, this.energyConfig), !this._customStartIso || !this._customEndIso) {
  ...
  _titleForFocusedNode() {
    if (this.overview)
      return l(T(this.hass), "energy.overview_title");
  ...
  _renderHoverOverlay() {
    ...
    return y`
      ...
      >
        <div class="pp-tooltip-time">${Yl(this._hover.ts)}</div>
  ...
  _renderDownloadButton() {
    const e = this._loading || this._historyByEntity.size === 0 || this._selectedIds.size === 0, i = l(T(this.hass), "energy.download_csv");
    return y`
      <button
        class="pp-icon-btn"
        ?disabled=${e}
...
const No = (t) => {
  ...
  return Number.isFinite(e) ? e : null;
}, Gt = (t) => String(t).padStart(2, "0"), Yl = (t) => {
...
const Gi = (t) => {
  ...
  // ------------------------------------------------------------
  connectedCallback() {
    super.connectedCallback(), this._series = Yn(this.hass, this.energyConfig);
  ...
  _renderTrend() {
    ...
    const _ = (h - u) * 0.06, p = u - _, g = h + _ - p, f = s - a, v = d.filter((w) => Number.isFinite(w.ts) && Number.isFinite(w.value)).map((w) => {
      const S = Math.max(0, Math.min(1, (w.ts - a) / f)), $ = Math.max(0, Math.min(1, (w.value - p) / g));
      return {
        x: S * r.width,
        y: (1 - $) * r.height,
        ts: w.ts,
    ...
    if (k.threshold === null)
      ...
      const w = v.map((A) => ({
        ...
        y: A.y,
        value: A.value
      })), S = Ie(b, k.color), $ = fl(w, k.threshold), z = gl($);
      for (const A of z)
        nr(
          r.ctx,
          A.points,
  ...
  render() {
    ...
    const _ = this._phase !== "open", p = this._phase === "closing", m = _ || p, g = this.originRect.width / c, f = this.originRect.height / d, v = this.originRect.left - u, b = this.originRect.top - h, x = {
      left: `${u}px`,
      top: `${h}px`,
      width: `${c}px`,
      height: `${d}px`,
      transform: m ? `translate(${v}px, ${b}px) scale(${g}, ${f})` : "translate(0, 0) scale(1, 1)",
      transformOrigin: "0 0"
    }, k = this._buildView();
    return y`
      <div
  ...
  _buildBatteryView(e, i, r) {
    const o = e === "battery" ? "battery_percentage_entity" : "battery_secondary_percentage_entity", n = e === "battery" ? "battery_entity" : "battery_secondary_entity", s = `${e}_icon`, a = `${e}_icon_color`, c = `${e}_low_alert`, d = `${e}_low_threshold`, u = `${e}_low_alert_color`, h = Gi(i[o]), _ = Gi(i[n]), p = _ ? U(this.hass, _) : void 0, m = typeof p == "string" && p.trim() === "%", g = h ? F(this.hass, h) : null, f = _ ? F(this.hass, _) : null, v = g !== null ? g : m ? f : null, b = v !== null ? `${Math.round(Math.max(0, Math.min(100, v)))}%` : "—", x = this._batteryIcon(
      v,
      m ? null : f,
      i[s]
    ), k = i[c] === !0, w = this._normalizeBatteryThreshold(i[d]), $ = k && v !== null && v <= w ? i[u] ?? "red" : i[a], z = Gi(i[`${e}_label`]) ?? r;
    return {
      iconName: x,
      iconStyle: xe($),
      formattedValue: b,
...
const oc = 4, nc = 8, Ho = 2, sc = /* @__PURE__ */ new Set(["solar", "home", "grid", "grid_secondary"]), ac = (t) => ({
  ...
  },
  {
    ...
    schema: [
      ...
      fe(l(t, "energy.editor.section_calculation"), [
        {
      ...
      fe(l(t, "energy.editor.section_trend"), [
  ...
  },
  {
    ...
    schema: [
      ...
      fe(l(t, "energy.editor.section_export"), [
        {
  ...
  Zt("solar", l(t, "energy.editor.section_solar_sub_blocks"), "mdi:solar-power-variant", oc, t),
  Zt("grid", l(t, "energy.editor.section_grid_1_sub_blocks"), "mdi:transmission-tower", Ho, t),
  Zt("grid_secondary", l(t, "energy.editor.section_grid_2_sub_blocks"), "mdi:transmission-tower", Ho, t),
  Zt("home", l(t, "energy.editor.section_home_sub_blocks"), "mdi:flash", nc, t),
  {
    type: "expandable",
    name: "",
...
const W = 0.01, xt = 1, ht = 1440 * 60 * 1e3, Bo = 300 * 1e3, Fo = 60 * 1e3, mc = 350, Vo = 4, Wo = 8, Zi = 2, yc = 260, fc = 220, Uo = -1e-6, Ye = "red", gc = "var(--rgb-primary-text-color, 33, 33, 33)", bc = [
  "hui-card-preview",
...
let me = class extends L {
  ...
  setConfig(t) {
    ...
    this._config = {
      ...
      grid_export_highlight: t.grid_export_highlight ?? !1,
      grid_export_trend_color: t.grid_export_trend_color ?? Ye,
      grid_export_icon_highlight: t.grid_export_icon_highlight ?? !1,
      grid_export_icon_color: t.grid_export_icon_color ?? Ye,
      grid_secondary_export_highlight: t.grid_secondary_export_highlight ?? !1,
      grid_secondary_export_trend_color: t.grid_secondary_export_trend_color ?? Ye,
      grid_secondary_export_icon_highlight: t.grid_secondary_export_icon_highlight ?? !1,
      grid_secondary_export_icon_color: t.grid_secondary_export_icon_color ?? Ye,
      shared_trend_scale: t.shared_trend_scale ?? !1,
      debug_performance: t.debug_performance ?? !1,
      ...
      battery_low_alert_color: t.battery_low_alert_color ?? Ye,
      ...
      battery_secondary_low_alert_color: t.battery_secondary_low_alert_color ?? Ye,
      battery_invert_flow: t.battery_invert_flow ?? !1,
      battery_invert_value_sign: t.battery_invert_value_sign ?? !1,
      battery_secondary_invert_flow: t.battery_secondary_invert_flow ?? !1,
      battery_secondary_invert_value_sign: t.battery_secondary_invert_value_sign ?? !1,
  ...
  render() {
    ...
    const t = this._config, e = t.decimals ?? xt, i = t.home_visible !== !1, r = t.solar_visible !== !1, o = t.grid_visible !== !1, n = o && t.grid_secondary_visible === !0, s = t.battery_visible !== !1, a = s && t.battery_secondary_visible === !0, c = this.normalizeBatteryDualAlignment(t.battery_dual_alignment), d = r ? this.collectSubBlocks("solar", t) : [], u = d.filter((N) => !N.stateMode), h = o ? this.collectSubBlocks("grid", t) : [], _ = n ? this.collectSubBlocks("grid_secondary", t) : [], p = i ? this.collectSubBlocks("home", t) : [], m = (N, wa) => N !== null ? N : this.preview ? wa : null, g = m(F(this.hass, t.home_entity), 3.2), f = r ? m(F(this.hass, t.solar_entity), 4.1) : null, v = o ? m(F(this.hass, t.grid_entity), -1.3) : null, b = n ? m(F(this.hass, t.grid_secondary_entity), 0.2) : null, x = s ? m(F(this.hass, t.battery_entity), 1.5) : null, k = m(F(this.hass, t.battery_percentage_entity), 72), w = a ? m(F(this.hass, t.battery_secondary_entity), 0) : null, S = m(
      ...
      Si
    ) : g, xs = wi ? O ?? "%" : ee, Ss = xi ? Q ?? "%" : Te, $s = this.toUnidirectionalFlow(vt), ks = this.toUnidirectionalFlow(Lt), Es = this.toBidirectionalFlow(v), Cs = this.toBidirectionalFlow(b), zs = this.sumComparableValues([
      { value: v, unit: A },
      { value: b, unit: P }
      ...
      { value: Gr, unit: ee },
      { value: Xr, unit: Te }
    ]), Os = x === null && w === null ? "none" : this.toBidirectionalFlow(Ds), Rs = t.battery_invert_value_sign === !0, Ns = t.battery_secondary_invert_value_sign === !0, Zr = Rs && x !== null ? -x : x, Yr = Ns && w !== null ? -w : w, Ls = this.hasConfiguredAction(t), $i = !this.isEditorPreview() && Ls, Hs = this.iconColorStyle(t.solar_icon_color), Bs = this.iconColorStyle(t.home_icon_color), Fs = this.iconShapeStyle(t.core_icon_color), ki = new Set(p.map((N) => N.index)), lt = new Set(d.map((N) => N.index)), Vs = ki.has(7) && ki.has(8), Ws = [5, 6, 7, 8].some((N) => ki.has(N)), Us = lt.has(1) && lt.has(2) && !lt.has(3) && !lt.has(4), js = lt.has(3) && lt.has(4), qr = n && (Us && Vs || js && Ws), Ks = n && !qr, Ei = p.some((N) => N.index >= 7), Jr = this.homeSubPositions(Ei), Qr = this.gridSubPositions(n), eo = this.gridSecondarySubPositions(), to = this.solarSubPositions(
      Ei,
      Ks,
      qr
    ), io = p.filter((N) => N.index <= (Ei ? 8 : 6)), Ci = o ? { col: 1, row: n ? 2 : 3, colSpan: 2, rowSpan: 2 } : null, zi = n ? { col: 1, row: 4, colSpan: 2, rowSpan: 2 } : null, Ti = s ? {
      col: a && c === "center" ? 2 : 3,
      row: 5,
      colSpan: 2,
      rowSpan: 2
    ...
    ), na = { "--flow-color-rgb": this.toRgbCss(t.flow_color) ?? gc }, ct = this.resolveColor("purple"), sa = this.resolveColor(t.solar_trend_color, ct), aa = this.resolveColor(t.grid_trend_color, ct), la = this.resolveColor(t.grid_secondary_trend_color, ct), ca = this.resolveColor(t.grid_export_trend_color, Wt), da = this.resolveColor(
      t.grid_secondary_export_trend_color,
      Wt
    ), ha = this.resolveColor(t.home_trend_color, ct), ua = this.resolveColor(t.battery_trend_color, ct), _a = this.resolveColor(t.battery_secondary_trend_color, ct), pa = t.grid_export_highlight === !0 ? Uo : null, ma = t.grid_secondary_export_highlight === !0 ? Uo : null, ya = no && wi ? oo : null, fa = wi ? Ne : Zr, ga = ao && xi ? so : null, ba = xi ? Le : Yr, va = this.buildFlowSegments(
      Pi,
      ro,
      Ai,
      [
    ...
    return y`
      ...
      da
            ...
            ${this._showSubBlocks ? this.renderSubNodes("grid_secondary", _, Zs, e) : E}
            ${this._showSubBlocks ? this.renderSubNodes("home", io, Ys, e) : E}
      ...
      Ii
                    ...
                    <div class="energy-content">
                      ...
                      <div class="energy-number">${this.formatValue(Zr, ee, e)}</div>
      ...
      Di
                    ...
                    <div class="energy-content">
                      ...
                      <div class="energy-number">${this.formatValue(Yr, Te, e)}</div>
  ...
  collectSubBlocks(t, e) {
    if (!this.hass)
      return [];
    const i = [], r = t === "solar" ? "mdi:solar-power-variant" : t === "home" ? "mdi:flash" : "mdi:transmission-tower", o = t === "solar" ? "Solar" : t === "home" ? "Home" : t === "grid" ? "Grid" : "Grid 2", n = t === "solar" ? Vo : t === "home" ? Wo : Zi;
    for (let h = 1; h <= n; h += 1) {
  ...
  computeGridBounds(t, e, i, r, o, n, s, a, c, d, u, h, _, p, m, g, f, v) {
  ...
  buildFlowSegments(t, e, i, r, o, n, s, a, c, d) {
    const u = this.placementCenter(e, d), h = [], _ = (m, g, f, v) => {
      const b = Math.min(m, g), x = Math.abs(g - m);
      x <= W || h.push({
    ...
    if (r.length === 1) {
      const [{ placement: m, direction: g }] = r, f = this.placementCenter(m, d);
      _(f.x, u.x, u.y, g);
    } else if (r.length >= 2) {
      const m = r.map((v) => ({
        direction: v.direction,
        center: this.placementCenter(v.placement, d)
      })).sort((v, b) => v.center.y - b.center.y), g = Math.min(...m.map((v) => v.center.x)), f = u.x - (u.x - g) * 0.5;
      _(u.x, f, u.y, o), m.forEach((v) => {
        const b = v.center.y > u.y + W ? this.reverseFlowDirection(v.direction) : v.direction;
        p(u.y, v.center.y, f, b), _(v.center.x, f, v.center.y, v.direction);
      });
    }
    if (n.length === 1) {
      const [{ placement: m, direction: g }] = n, f = this.placementCenter(m, d);
      p(u.y, f.y, u.x, g);
    } else if (n.length >= 2) {
      const m = n.map((v) => ({
        ...
        direction: v.direction,
        center: this.placementCenter(v.placement, d)
      })).sort((v, b) => v.center.y - b.center.y), g = Math.min(
        ...m.map((v) => (v.placement.row - 1) / d.rows * 100)
      ), f = Math.max(u.y + W, g);
      p(u.y, f, u.x, s), m.forEach((v) => {
        const b = v.center.x < u.x - W ? this.reverseFlowDirection(v.direction) : v.direction;
        _(u.x, v.center.x, f, b), p(f, v.center.y, v.center.x, v.direction);
      });
    }
    return h;
  }
  ...
  toTrendCoordinates(t, e) {
    ...
    }), p = ((v = _[0]) == null ? void 0 : v.x) ?? o, m = ((b = _[_.length - 1]) == null ? void 0 : b.x) ?? n, g = Math.max(0, m - p), f = 18;
    if (_.length >= 2 && g < f) {
      const x = n - f, k = Math.max(o, Math.min(x, m - f));
      if (g <= W) {
  ...
  updateSubBlockVisibility() {
    ...
    const e = t.getBoundingClientRect(), i = e.width <= yc || e.height <= fc;
  ...
  drawSubNodeConnectors() {
    ...
    s && this.renderRoot.querySelectorAll(".energy-sub-value.home-sub").forEach((w) => {
      const S = w.getBoundingClientRect(), $ = S.top + S.height / 2, z = S.left + S.width / 2 < u ? S.right : S.left, A = $, P = $ < s.top ? s.top : $ > s.bottom ? s.bottom : $, D = m(u), O = g(A), H = g(P), Q = m(z);
      b(Q, D, O, "home"), x(O, H, D, "home");
    }), a && this.renderRoot.querySelectorAll(".energy-sub-value.solar-sub").forEach((w) => {
      const S = w.getBoundingClientRect(), $ = S.left + S.width / 2, z = S.top + S.height / 2 < h ? S.bottom : S.top, A = $, P = $ < a.left ? a.left : $ > a.right ? a.right : $, D = g(h), O = m(A), H = m(P), Q = g(z);
      x(Q, D, O, "solar"), b(O, H, D, "solar");
    }), c && this.renderRoot.querySelectorAll(".energy-sub-value.grid-sub").forEach((w) => {
      const S = w.getBoundingClientRect(), $ = S.top + S.height / 2, z = S.left + S.width / 2 < _ ? S.right : S.left, A = $, P = $ < c.top ? c.top : $ > c.bottom ? c.bottom : $, D = m(_), O = g(A), H = g(P), Q = m(z);
      b(Q, D, O, "grid"), x(O, H, D, "grid");
    }), d && this.renderRoot.querySelectorAll(".energy-sub-value.grid_secondary-sub").forEach((w) => {
      const S = w.getBoundingClientRect(), $ = S.top + S.height / 2, z = S.left + S.width / 2 < p ? S.right : S.left, A = $, P = $ < d.top ? d.top : $ > d.bottom ? d.bottom : $, D = m(p), O = g(A), H = g(P), Q = m(z);
  ...
  drawTrendCanvases() {
    ...
    Object.keys(this._trendDrawConfig).forEach((_) => {
      ...
      if (!p)
        return;
      const m = r.get(_), g = o.get(_);
      if (!m || !g)
        return;
      const f = n[_];
      if (!f || f.length < 2)
        return;
      const v = s && a !== null && this.isSharedScaleParticipant(_), b = v ? (a == null ? void 0 : a[_]) ?? 1 : 1, x = v ? this.scaleTrendSeries(f, b) : f, k = v ? c : null, w = this.toTrendCoordinates(x, k);
      if (w.length < 2)
        return;
      ...
      this.drawTrendArea(
        ...
        p.threshold,
        p.thresholdColor
      ), this.drawTrendLine(g.ctx, $, p.color, p.threshold, p.thresholdColor), d += 1, u += $.length;
  ...
  withAlpha(t, e) {
    return ft(t, e, this._canvasColorContextCache);
  }
  connectedCallback() {
    ...
    try {
      ...
      for (const S of o) {
        if (S === "home" && i.home_auto_calculate === !0) {
          ...
          const H = ((n = O[O.length - 1]) == null ? void 0 : n.ts) ?? f, Q = Math.max(f, H - Fo);
        ...
        if (p.has($))
          continue;
        m.add($);
        const A = ((s = z[z.length - 1]) == null ? void 0 : s.ts) ?? f, P = Math.max(f, A - Fo);
        g = Math.min(g, P);
      }
      let v = 0;
      ...
      d.forEach((S, $) => {
        ...
        if (p.has(S)) {
          const A = b[S] ?? [];
          c[$] = A.length > 0 ? A : z.filter((P) => P.ts >= f);
          return;
        }
        if (m.has(S)) {
          const A = k[S] ?? [];
  ...
  relevantEntityIds(t) {
    ...
    return r("solar", Vo), r("home", Wo), r("grid", Zi), r("grid_secondary", Zi), Array.from(e);
  }
...
const we = (t) => {
  ...
  return [
    ...
    o,
    ...n,
    ...Array.from({ length: vc }, (c, d) => xc(d + 1)),
    a,
    s
  ];
}, Me = (t) => {
...
}, ys = (t) => t === "column" ? "column" : "row", fs = (t) => kr(t), gs = (t) => Er(t), Yt = (t, e, i) => {
  const r = t ?? e;
  ...
  entity_1_trend_color: Yt(t.entity_1_trend_color, t.trend_color, 1),
  ...
  entity_2_trend_color: Yt(t.entity_2_trend_color, void 0, 2),
  ...
  entity_3_trend_color: Yt(t.entity_3_trend_color, void 0, 3),
  ...
  entity_4_trend_color: Yt(t.entity_4_trend_color, void 0, 4)
}), Sc = {
...
let di = class extends L {
  ...
  setConfig(t) {
    const e = {
      ...
      timeframe_hours: fs(t.timeframe_hours),
      ...
      decimals_base_unit: t.decimals_base_unit ?? t.decimals ?? 1,
      decimals_prefixed_unit: t.decimals_prefixed_unit ?? t.decimals ?? 1,
      line_thickness: gs(t.line_thickness),
...
let $e = class extends L {
  ...
  collectSeriesEntries(t, e) {
    ...
    for (let r = 1; r <= $t; r += 1) {
      ...
      if (!n || !s)
        continue;
      const a = this.entityName(this.slotCustomName(o, t), s, r), c = F(this.hass, s), d = t.unit ?? U(this.hass, s) ?? "", u = this.formatValue(c, d, e), h = this.slotIcon(o, t), _ = this.iconStyle(this.slotIconColor(o, t)), p = this.resolveColor(_n[o], Ac), m = this.resolveColor(this.slotTrendColor(o, t), p);
      i.push({
        slot: o,
        entityId: s,
        name: a,
  ...
  toTrendCoordinates(t, e, i) {
    ...
    const u = 20, h = 80, _ = Math.max(d - c, qt), p = t.map((k) => {
      const w = Math.max(0, Math.min(100, (k.ts - o) / e * 100)), S = n + w / 100 * (s - n), $ = _ <= qt ? 0.5 : (k.value - c) / _, z = h - $ * (h - u);
      return { x: S, y: z, value: k.value, ts: k.ts };
    }), m = ((b = p[0]) == null ? void 0 : b.x) ?? n, g = ((x = p[p.length - 1]) == null ? void 0 : x.x) ?? s, f = Math.max(0, g - m), v = 18;
    if (p.length >= 2 && f < v) {
      const k = s - v, w = Math.max(n, Math.min(k, g - v));
      if (f <= qt) {
        const $ = v / (p.length - 1);
        return p.map((z, A) => ({
          ...z,
  ...
  drawTrendCanvases() {
    ...
    const n = ((g = this._config) == null ? void 0 : g.fill_area_enabled) !== !1, s = this.trendWindowMs(this._config), a = {};
    this._drawConfigs.forEach((v) => {
      const b = this.trendPoints(v.slot, v.currentValue);
      b.length >= 2 && (a[v.slot] = b);
    });
    const c = ((f = this._config) == null ? void 0 : f.shared_trend_scale) === !0, d = c ? this.resolveSharedScaleFactors(a) : null;
...
let ke = class extends L {
  ...
  collectSeriesEntries(t, e) {
    ...
    for (let r = 1; r <= ut; r += 1) {
      ...
      if (!n || !s)
        continue;
      const a = this.entityName(this.slotCustomName(o, t), s, r), c = F(this.hass, s), d = t.unit ?? U(this.hass, s) ?? "", u = this.formatValue(c, d, e), h = this.slotIcon(o, t), _ = this.iconStyle(this.slotIconColor(o, t)), p = this.resolveColor(yn[o], Hc), m = this.resolveColor(this.slotTrendColor(o, t), p);
      i.push({
        slot: o,
        entityId: s,
        name: a,
  ...
  withStackedCurrentValues(t, e, i) {
    ...
    if (e && o !== void 0 && !n) {
      ...
      a = m ? s(m) : 0, c = o;
    } else e && n ? (a = t.reduce((m, g) => g.slot !== o ? m + s(g) : m, 0), c = o) : (a = t.reduce((m, g) => m + s(g), 0), c = (p = t[t.length - 1]) == null ? void 0 : p.slot);
    const d = Number.isFinite(a) && Math.abs(a) > qe;
    let u = 0, h = 0, _ = !1;
    return t.map((m) => {
      const g = o !== void 0 && m.slot === o && !n;
      m.currentValue !== null && Number.isFinite(m.currentValue) && (g || (u += m.currentValue, r && (h += m.currentValue * (r[m.slot] ?? 1))), _ = !0);
      let f;
      if (!_)
        f = null;
      else if (e)
        if (!d)
          ...
          const b = r ? h : u;
          f = m.slot === c ? 100 : Math.max(0, Math.min(100, b / a * 100));
        }
      else
        f = r ? h / (r[m.slot] ?? 1) : u;
      const v = e ? "%" : m.unit;
      return {
        ...m,
        unit: v,
        secondary: this.formatValue(f, v, m.decimals)
      };
    });
  }
  slotEntityId(t, e) {
  ...
  toTrendCoordinates(t, e, i) {
    ...
    const u = 20, h = 80, _ = Math.max(d - c, qe), p = t.map((k) => {
      const w = Math.max(0, Math.min(100, (k.ts - o) / e * 100)), S = n + w / 100 * (s - n), $ = _ <= qe ? 0.5 : (k.value - c) / _, z = h - $ * (h - u);
      return { x: S, y: z, value: k.value, ts: k.ts };
    }), m = ((b = p[0]) == null ? void 0 : b.x) ?? n, g = ((x = p[p.length - 1]) == null ? void 0 : x.x) ?? s, f = Math.max(0, g - m), v = 18;
    if (p.length >= 2 && f < v) {
      const k = s - v, w = Math.max(n, Math.min(k, g - v));
  ...
  drawTrendCanvases() {
    ...
    [...this._drawConfigs].sort((w, S) => S.slot - w.slot).forEach((w) => {
      ...
      n && this.drawTrendArea(r.ctx, z, w.color, r.height), this.drawTrendLine(o.ctx, A, w.color, w.lineWidth), u[w.slot] = A, g += 1, f += A.length;
...
const jc = 0.01, fn = "power-pilz-wallbox-mode-menu-portal-style", Lr = class Lr extends L {
  constructor() {
    super(...arguments), this.preview = !1, this.editMode = !1, this._actionBusy = !1, this._modeMenuOpen = !1, this._modeMenuOptionCount = 0, this.toggleModeMenu = (e) => {
      ...
      if (e.stopPropagation(), this.isEditorPreview() || !((s = this._config) != null && s.mode_entity) || this._actionBusy)
        return;
      const i = R(this.hass, this._config.mode_entity), r = (i == null ? void 0 : i.state) ?? "", o = this.getModeOptions(i);
      if (o.length === 0)
        return;
  ...
  setConfig(e) {
    ...
    this._config = {
      ...
      name: e.name ?? l(T(this.hass), "wallbox.default_name"),
  ...
  render() {
    ...
    if (!this.hass)
      return y``;
    const i = this._config, r = F(this.hass, i.power_entity), o = r !== null ? r : this.preview ? 7.2 : null, n = U(this.hass, i.power_entity) ?? "kW", s = oi(this.hass, i.status_entity), a = s || (this.preview ? "charging" : s), c = R(this.hass, i.mode_entity), d = (c == null ? void 0 : c.state) ?? (this.preview ? "Eco" : ""), u = this.getModeOptions(c), h = u.length > 0 ? u : this.preview ? ["Eco", "Fast", "Solar"] : u, _ = this.isCharging(a, o, i.command_entity), p = this.resolveActionCommand(_), m = _ ? l(e, "wallbox.stop") : l(e, "wallbox.start"), g = _ ? "mdi:pause" : "mdi:play", f = this.statusLabel(a, _), v = this.formatPower(o, n, i.decimals ?? 1), b = this.showModeSelector(i, h), x = this.showLiveValue(i), k = this.showCommandButton(i), w = this.isEditorPreview() || this._actionBusy || !i.mode_entity || h.length === 0, S = d || h[0] || l(e, "wallbox.mode_fallback"), $ = this._modeMenuOpen ? "mdi:chevron-up" : "mdi:chevron-down", z = this.iconStyle(i.icon_color), P = Number(x) + Number(k) === 1, D = b && x && k, O = P && x, H = P && k || D, Q = O || H, ee = x && !O, Te = k && !H, Ne = b || ee || Te, Le = b ? ee || Te ? Te ? "actions" : "actions no-command" : "actions mode-only" : "actions no-mode";
...
var Zc = Object.defineProperty, Nt = (t, e, i, r) => {
  for (var o = void 0, n = t.length - 1, s; n >= 0; n--)
    (s = t[n]) && (o = s(e, i, o) || o);
  return o && Zc(e, i, o), o;
};
const Yc = 5, gn = 4, qc = {
  ...
  setConfig(e) {
    ...
    this._config = {
      ...
      name: e.name ?? l(T(this.hass), "switch.default_name")
  ...
  getOptions(e) {
    ...
    return Array.from(new Set(r)).slice(0, Yc);
  }
  activeIndex(e, i) {
    const r = e.indexOf(i);
    return r >= 0 ? r : 0;
  ...
  render() {
    ...
    if (!this.hass)
      return y``;
    const e = this._config, i = R(this.hass, e.entity), r = (i == null ? void 0 : i.state) ?? "", o = this.getOptions(i), n = this.activeIndex(o, r), s = n === 0 && e.dim_inactive_icon !== !1, a = this.iconStyle(s ? "disabled" : e.icon_color), c = o.length, d = c > 0 ? n / c * 100 : 0, u = c > 0 ? 100 / c : 100, h = (k = i == null ? void 0 : i.attributes) == null ? void 0 : k.friendly_name, _ = e.subtitle || r || l(T(this.hass), "common.unknown"), p = this.resolvedCardLayout(), m = this.resolvedSliderSize(), g = qc[m], f = c > 1, v = this.pillColor(n), b = {
      width: `calc(${u}% - ${gn * 2}px)`,
      left: `calc(${d}% + ${gn}px)`
    };
        ...
        <ha-card @click=${this.handleCardTap}>
          <div class="container vertical">
            <div class="state-item">
              ...
              <div class="info">
                <div class="primary">${e.name || h || l(T(this.hass), "switch.default_name")}</div>
...
const ur = "power-pilz-schedule-edit-dialog", Yi = [
...
const Br = class Br extends le {
  constructor() {
    super(...arguments), this.scheduleEntityId = "", this._blocks = bn(), this._uniformBlocks = [], this._sameForAll = !1, this._loading = !0, this._saving = !1, this._dirty = !1, this._handleSave = async () => {
      ...
      const e = !this._sameForAll;
      if (e) {
        const i = Yi.map((r) => this._blocks[r.key]).find((r) => Array.isArray(r) && r.length > 0);
  ...
  _saveBlockEdit() {
    ...
    const e = T(this.hass), { day: i, index: r, from: o, to: n, dataText: s } = this._editing, a = X(o), c = X(n);
    if (isNaN(a) || isNaN(c)) {
    ...
    if (h.some(
      (m, g) => g !== r && qi(X(m.from), X(m.to), a, c)
    )) {
  ...
  renderBody() {
    ...
    const i = this._sameForAll ? [{ key: "monday", label: l(e, "schedule.edit_dialog.all_days") }] : Yi.map((r) => ({ key: r.key, label: re(e, r.dayIndex) }));
    return y`
      <div class="editor">
        <div class="pp-toolbar">
  ...
  renderInner() {
    ...
    const e = T(this.hass), i = this._editing, r = re(
      e,
      ((o = Yi.find((n) => n.key === i.day)) == null ? void 0 : o.dayIndex) ?? 0
    );
    return y`
    ...
    return y`
      <div class="day-row">
        ...
        >
          ${r.map((c, d) => {
      var x, k, w;
      const u = ((x = this._moveDrag) == null ? void 0 : x.day) === e && this._moveDrag.index === d, h = X(c.from), _ = X(c.to), p = u ? h + (((k = this._moveDrag) == null ? void 0 : k.deltaMin) ?? 0) : h, m = u ? _ + (((w = this._moveDrag) == null ? void 0 : w.deltaMin) ?? 0) : _, g = p / ue * 100, f = (m - p) / ue * 100, v = u ? Et(p) : c.from.slice(0, 5), b = u ? Et(m) : c.to.slice(0, 5);
      return y`
              <div
                class="pp-block ${u ? "moving" : ""}"
                data-day=${e}
                data-index=${d}
                style=${M({ left: `${g}%`, width: `${f}%` })}
...
customElements.get(ur) || customElements.define(ur, Z);
function id(t) {
...
const wn = "powerpilz-schedule-edit", Ji = [
  ...
  setConfig(e) {
    ...
    this._config = {
      ...
      name: e.name ?? l(T(this.hass), "schedule.default_name"),
  ...
  modeValue() {
    ...
    if (!e) return "auto";
    const i = R(this.hass, e), r = (i == null ? void 0 : i.state) ?? "auto", o = (n = i == null ? void 0 : i.attributes) == null ? void 0 : n.mode_names;
    if (o && typeof o == "object") {
  ...
  modeLabel(e) {
    ...
    const i = this._modeEntityId;
    if (i) {
      const o = R(this.hass, i), n = (r = o == null ? void 0 : o.attributes) == null ? void 0 : r.mode_names;
  ...
  renderTimeline() {
    ...
    if (h) {
      const p = Math.ceil(i / 60), m = Math.floor(r / 60), g = o > 720 ? 6 : o > 360 ? 3 : 2;
      for (let f = p; f <= m; f += g) {
        const v = f * 60;
        v >= i && v <= r && _.push({ hour: f >= 24 ? 0 : f, pct: (v - i) / o * 100 });
      }
    }
    return y`
      ...
      (p) => y`<span class="time-label" style=${M({ left: `${p.pct}%` })}>${String(p.hour).padStart(2, "0")}</span>`
        ...
        <div class="timeline-track">
          ${n.map((p) => {
      const m = this.timeToMinutes(p.from), g = this.timeToMinutes(p.to), f = Math.max(m, i), v = Math.min(g, r);
      if (v <= f) return E;
      const b = (f - i) / o * 100, x = (v - f) / o * 100;
      return y`
              <div
  ...
  _renderDemo() {
    ...
    if (d) {
      const f = Math.ceil(i / 60), v = Math.floor(r / 60), b = o > 720 ? 6 : o > 360 ? 3 : 2;
      for (let x = f; x <= v; x += b) {
        const k = x * 60;
        k >= i && k <= r && p.push({ hour: x >= 24 ? 0 : x, pct: (k - i) / o * 100 });
      }
    }
    const m = (/* @__PURE__ */ new Date()).getDay(), g = T(this.hass);
    return y`
      <ha-card>
        <div class="container ${h ? "vertical" : "horizontal"}">
          <div class="row row-header">
            <div class="state-item">
              ...
              <div class="info">
                <div class="primary">${e.name || l(g, "schedule.default_name")}</div>
      ...
      (f) => y`<span class="time-label" style=${M({ left: `${f.pct}%` })}>${String(f.hour).padStart(2, "0")}</span>`
              ...
              <div class="timeline-track">
                ${_.map((f) => {
      const v = (f.startMin - i) / o * 100, b = (f.endMin - f.startMin) / o * 100;
      return y`
  ...
  render() {
    var p, m;
    if (!this._config) return y`<ha-card>${l(T(this.hass), "common.invalid_config")}</ha-card>`;
    ...
    const e = this._config, i = (m = (p = R(this.hass, this._scheduleEntityId)) == null ? void 0 : p.attributes) == null ? void 0 : m.friendly_name, r = this.modeValue(), o = e.subtitle || this.modeLabel(r), n = e.show_day_selector !== !1, s = e.show_mode_control !== !1 && !!this._modeEntityId, a = e.show_time_labels !== !1, c = e.card_layout === "vertical", d = !c && !n && !s && !a, h = this.isDeviceOn() ? this.iconStyle(e.icon_color) : this.iconStyle("disabled"), _ = y`
      <div class="state-item">
        ...
        <div class="info">
          <div class="primary">${e.name || i || l(T(this.hass), "schedule.default_name")}</div>
          <div class="secondary">${o}</div>
        </div>
...
const kn = "powerpilz-event-schedule-edit", tr = [
  ...
  setConfig(e) {
    this._config = {
      ...
      name: e.name ?? l(T(this.hass), "event_schedule.default_name"),
      time_window: e.time_window ?? "24",
      show_day_selector: e.show_day_selector ?? !0,
      show_mode_control: e.show_mode_control ?? !0,
  ...
  renderTimeline() {
    ...
    if (u) {
      ...
      for (let g = _; g <= p; g += m) {
        const f = g * 60;
        f >= i && f <= r && h.push({ hour: g >= 24 ? 0 : g, pct: (f - i) / o * 100 });
      }
    }
    return y`
      <div class="timeline-container">
  ...
  _renderDemo() {
    ...
    if (c) {
      const g = Math.ceil(i / 60), f = Math.floor(r / 60), v = o > 720 ? 6 : o > 360 ? 3 : 2;
      for (let b = g; b <= f; b += v) {
        const x = b * 60;
        ...
        <div class="container ${u ? "vertical" : "horizontal"}">
          ...
          ${d ? y`
                <div class="row row-days">
                  <div class="day-selector">
                    ${tr.map((g, f) => y`
                      <button type="button" class="day-btn ${f === p ? "active today" : ""}" disabled>
                        ${re(m, f)}
                      </button>
                    `)}
                  </div>
  ...
  renderTriggerNowButton() {
    var u, h, _;
    const e = this._scheduleEntityId, i = e ? (_ = (h = (u = this.hass) == null ? void 0 : u.states) == null ? void 0 : h[e]) == null ? void 0 : _.attributes : void 0, r = (i == null ? void 0 : i.pulse_running) === !0, o = i == null ? void 0 : i.pulse_blocked_until, n = typeof o == "string" ? Date.parse(o) : NaN, s = Number.isFinite(n) && n > Date.now(), a = r || s, c = T(this.hass);
    let d = l(c, "event_schedule.trigger_now");
    if (r)
      d = l(c, "event_schedule.trigger_now_blocked_running");
    else if (s) {
      const p = new Date(n), m = String(p.getHours()).padStart(2, "0"), g = String(p.getMinutes()).padStart(2, "0"), f = String(p.getSeconds()).padStart(2, "0");
  ...
  render() {
      ...
      return y`
        <ha-card>
          <div class="placeholder">
            ...
            <div class="placeholder-text">${l(g, "event_schedule.placeholder")}</div>
          </div>
        </ha-card>
      `;
    }
    const e = this._config, i = (m = (p = R(this.hass, this._scheduleEntityId)) == null ? void 0 : p.attributes) == null ? void 0 : m.friendly_name, r = this.modeValue(), o = e.subtitle || this.modeLabel(r), n = e.show_day_selector !== !1, s = e.show_mode_control !== !1 && !!this._modeEntityId, a = e.show_trigger_button !== !1, c = e.show_time_labels !== !1, d = e.card_layout === "vertical", u = !d && !n && !s && !a && !c, h = this.iconStyle(e.icon_color), _ = y`
      <div class="state-item">
        ...
        <div class="info">
          <div class="primary">${e.name || i || l(T(this.hass), "event_schedule.default_name")}</div>
          <div class="secondary">${o}</div>
        </div>
...
let yi = class extends L {
  ...
  buildSchema() {
    var r;
    const t = T(this.hass), e = ((r = this._config) == null ? void 0 : r.use_companion) !== !1;
    return [
      {
        type: "expandable",
        name: "",
        ...
        schema: [
          {
            name: "use_companion",
            selector: { boolean: {} },
            helper: l(t, "timer.editor.use_companion_help"),
            description: l(t, "timer.editor.use_companion_help")
          },
          ...e ? [
            {
          ...
          ] : [
            {
              ...
              helper: l(t, "timer.editor.switch_help"),
              description: l(t, "timer.editor.switch_help")
            },
            {
              name: "on_datetime_entity",
              selector: { entity: { filter: { domain: "input_datetime" } } },
              helper: l(t, "timer.editor.on_help"),
              description: l(t, "timer.editor.on_help")
            },
            {
              name: "off_datetime_entity",
              selector: { entity: { filter: { domain: "input_datetime" } } },
              helper: l(t, "timer.editor.off_help"),
              description: l(t, "timer.editor.off_help")
            },
            {
              name: "active_entity",
              selector: { entity: { filter: { domain: "input_boolean" } } },
              helper: l(t, "timer.editor.active_help"),
              description: l(t, "timer.editor.active_help")
            }
          ]
        ]
      },
  ...
  labelMap() {
    const t = T(this.hass);
    return {
      use_companion: l(t, "timer.editor.use_companion"),
      companion_entity: l(t, "timer.editor.companion_entity"),
      switch_entity: l(t, "timer.editor.switch_entity"),
      on_datetime_entity: l(t, "timer.editor.on_datetime_entity"),
      off_datetime_entity: l(t, "timer.editor.off_datetime_entity"),
      active_entity: l(t, "timer.editor.active_entity"),
  ...
  helperMap() {
    const t = T(this.hass);
    return {
      use_companion: l(t, "timer.editor.use_companion_help"),
      companion_entity: l(t, "timer.editor.companion_help"),
      switch_entity: l(t, "timer.editor.switch_help"),
      on_datetime_entity: l(t, "timer.editor.on_help"),
      off_datetime_entity: l(t, "timer.editor.off_help"),
      active_entity: l(t, "timer.editor.active_help"),
...
const Ur = class Ur extends L {
  ...
  static async getStubConfig(e) {
    const i = (e == null ? void 0 : e.states) ?? {}, r = Object.keys(i), o = r.find((s) => {
      var c;
      if (!s.startsWith("switch.")) return !1;
      const a = (c = i[s]) == null ? void 0 : c.attributes;
    ...
    const n = (s) => r.find((a) => a.startsWith(`${s}.`));
    return {
      type: "custom:power-pilz-timer-card",
      use_companion: !1,
  ...
  setConfig(e) {
    ...
    this._config = {
      ...
      name: e.name ?? l(T(this.hass), "timer.default_name")
    };
  }
  ...
  get _switchEntityId() {
    ...
    const e = (o = (r = this.hass) == null ? void 0 : r.states) == null ? void 0 : o[this._config.companion_entity ?? ""], i = (n = e == null ? void 0 : e.attributes) == null ? void 0 : n.target_entity;
    return typeof i == "string" ? i : void 0;
  }
  _companionAttr(e) {
    var r, o, n, s, a;
  ...
  _getOnDatetime() {
    ...
    if (((e = this._config) == null ? void 0 : e.use_companion) !== !1) {
      ...
      return typeof r == "string" ? Cn(r) : null;
    }
  ...
  _hasOffSupport() {
    var i, r, o;
    return this._direction() === "on_only" ? !1 : ((i = this._config) == null ? void 0 : i.use_companion) !== !1 ? !!((r = this._config) != null && r.companion_entity) : !!((o = this._config) != null && o.off_datetime_entity);
  }
  _companionStateIcon() {
    var o;
  ...
  _targetHasOptions() {
    ...
    if (!e) return !1;
    const i = (s = (n = this.hass) == null ? void 0 : n.states) == null ? void 0 : s[e], r = (a = i == null ? void 0 : i.attributes) == null ? void 0 : a.options;
  ...
  async _writeOnDatetime(e, i) {
    ...
    if (((o = this._config) == null ? void 0 : o.use_companion) !== !1) {
      const s = (n = this._config) == null ? void 0 : n.companion_entity;
      if (!s) return;
      const a = {
        entity_id: s,
        on: e
      };
      i !== void 0 && (a.on_option = i), await this.hass.callService(ei, "set_timer", a);
      return;
    }
  ...
  async _writeOffDatetime(e, i) {
    ...
    if (((o = this._config) == null ? void 0 : o.use_companion) !== !1) {
      ...
      i !== void 0 && (a.off_option = i), await this.hass.callService(ei, "set_timer", a);
      return;
    }
  ...
  renderPortalContent() {
    ...
    if (this._portal.replaceChildren(), this._confirmingCancel) {
      ...
      z.type = "button", z.className = "pp-act cancel", z.textContent = l(e, "timer.keep_timer"), z.addEventListener("click", () => this.handleDismissConfirm()), $.append(z);
      const A = document.createElement("button");
    ...
    const i = this._targetHasOptions() ? this._resolveOptionLabel(this._pickOnOption) || this._onOptionLabel() : this._onOptionLabel(), r = this._targetHasOptions() ? this._resolveOptionLabel(this._pickOffOption) || this._offOptionLabel() : this._offOptionLabel(), o = i ? l(e, "timer.set_to_at", { option: i }) : l(e, "timer.turn_on_at"), n = r ? l(e, "timer.set_to_at", { option: r }) : l(e, "timer.turn_off_at_optional"), s = this._pickingOn ? o : n, a = this._pickingOn && this._hasOffSupport() && this._hasOnSupport(), c = this._pickingOff && this._hasOnSupport() && this._hasOffSupport() && !this._skippedOn, d = this._pickingOn ? r ? l(e, "timer.only_option", { option: r }) : l(e, "timer.only_off") : i ? l(e, "timer.only_option", { option: i }) : l(e, "timer.only_on"), u = this._pickingOn ? this.handleSkipOn : this.handleSkipOff, h = a || c, _ = this._pickingOn ? this.handleSetOn : this.handleSetOff, p = this.next7Days(), m = Array.from({ length: 24 }, (w, S) => S), g = document.createElement("div");
    g.className = "pp-label", g.textContent = s, this._portal.append(g);
    const f = document.createElement("div");
    f.className = "pp-days", p.forEach((w) => {
  ...
  parseDatetime(e) {
    ...
    if (!i) return null;
    const r = i.attributes, o = r == null ? void 0 : r.year, n = r == null ? void 0 : r.month, s = r == null ? void 0 : r.day, a = r == null ? void 0 : r.hour, c = r == null ? void 0 : r.minute;
    if (typeof o == "number" && typeof n == "number" && typeof s == "number") {
      const u = new Date(o, n - 1, s, a ?? 0, c ?? 0, 0, 0);
      if (!isNaN(u.getTime())) return u;
    }
    const d = i.state;
    if (typeof d == "string" && d.length > 10 && d !== "unknown" && d !== "unavailable") {
      const u = new Date(d.replace(" ", "T"));
  ...
  render() {
    ...
    if (!this._activeEntityId) {
      const p = this._config.use_companion !== !1 ? l(e, "timer.placeholder_companion") : l(e, "timer.placeholder_manual");
      return y`
        <ha-card>
          <div class="placeholder">
    ...
    const i = this._config, r = this.isActive(), o = this.switchIsOn(), n = xe(o ? i.icon_color : "disabled"), s = ((u = (d = R(this.hass, this._switchEntityId)) == null ? void 0 : d.attributes) == null ? void 0 : u.friendly_name) ?? ((_ = (h = R(this.hass, this._activeEntityId)) == null ? void 0 : h.attributes) == null ? void 0 : _.friendly_name), a = i.subtitle || this.buildSubtitle(r, o), c = l(e, "timer.default_name");
    return y`
      <ha-card>
        <div class="container">
          <div class="state-item">
...
var fd = Object.defineProperty, J = (t, e, i, r) => {
  for (var o = void 0, n = t.length - 1, s; n >= 0; n--)
    (s = t[n]) && (o = s(e, i, o) || o);
  return o && fd(e, i, o), o;
};
...
const jr = class jr extends le {
    ...
    try {
      ...
      if (s && typeof s == "object" && !Array.isArray(s))
        for (const p of Object.keys(a)) {
          ...
          })).filter((g) => Number.isFinite(g.value)).sort((g, f) => he(g.time) - he(f.time)));
        }
      this._points = a;
  ...
  renderInner() {
    var n;
    if (!this._editing) return E;
    const e = T(this.hass), i = this._editing, r = this._sameForAll ? l(e, "heating_curve.edit_dialog.all_days") : re(e, ((n = Ct.find((s) => s.key === i.day)) == null ? void 0 : n.dayIndex) ?? 0), o = this._pointsForDay(i.day).length > 1;
    return y`
      <div class="inner-backdrop" @click=${() => this._cancelEdit()}>
  ...
  _renderDayRow(e, i, r) {
    ...
    }), u = o.map((x) => ({ x: he(x.time), y: x.value })).sort((x, k) => x.x - k.x), h = mr(u, d), _ = ((v = this._cursor) == null ? void 0 : v.day) === e && !this._drag, p = _ ? Ae + this._cursor.min / Fe * s : 0, m = _ ? p / ti * 100 : 0, g = !!this._clipboard, f = ((b = this._clipboard) == null ? void 0 : b.source) === e;
    return y`
      <div class="hc-row">
...
var $d = Object.defineProperty, gt = (t, e, i, r) => {
  for (var o = void 0, n = t.length - 1, s; n >= 0; n--)
    (s = t[n]) && (o = s(e, i, o) || o);
  return o && $d(e, i, o), o;
};
const Mn = "powerpilz-heating-curve-edit", An = [
  ...
  setConfig(e) {
    this._config = {
      ...
      name: e.name ?? l(T(this.hass), "heating_curve.default_name"),
      show_day_selector: e.show_day_selector ?? !0,
      show_mode_control: e.show_mode_control ?? !0,
      show_now_indicator: e.show_now_indicator ?? !0,
      show_time_labels: e.show_time_labels ?? !0
  ...
  renderCurvePreview() {
    ...
    const u = 1e3, h = 80, _ = Math.max(1e-4, o - r), m = mr(d, (b) => ({
      x: b.x / 1440 * u,
      y: (1 - (b.y - r) / _) * h
    })), g = d.length >= 2 ? `${m} L ${u} ${h} L 0 ${h} Z` : "", f = e.show_time_labels !== !1, v = f ? Pn() : [];
    return y`
  ...
  _renderDemo() {
    const e = this._config, i = T(this.hass), r = this._resolvedActiveColor(), o = e.show_day_selector !== !1, n = e.show_mode_control !== !1, s = (/* @__PURE__ */ new Date()).getDay(), a = [
      ...
      x: b.x / 1440 * c,
      y: (1 - (b.y - u) / _) * d
    })), g = `${m} L ${c} ${d} L 0 ${d} Z`, f = this._nowMin(), v = e.show_now_indicator !== !1;
    return y`
      <ha-card>
        <div class="container">
          <div class="row row-header">
      ...
      return y`
        <ha-card>
          <div class="placeholder">
            ...
            <div class="placeholder-text">${l(g, "heating_curve.placeholder")}</div>
          </div>
        </ha-card>
      `;
    }
    const e = this._config, i = (m = (p = R(this.hass, this._entityId)) == null ? void 0 : p.attributes) == null ? void 0 : m.friendly_name, r = this._modeValue(), o = this._currentValue(), n = this._unit(), s = e.subtitle || (o !== null ? `${o.toFixed(1)} ${n} · ${this._modeLabel(r)}` : this._modeLabel(r)), a = e.show_day_selector !== !1, c = e.show_mode_control !== !1, d = e.show_time_labels !== !1, u = !a && !c && !d, _ = this._isDeviceOn() ? this.iconStyle(e.icon_color) : this.iconStyle("disabled");
    return y`
      <ha-card>
        <div class="container${u ? " compact-inline" : ""}">
          <div class="row row-header">
            <div class="state-item">
              ...
              <div class="info">
                <div class="primary">${e.name || i || l(T(this.hass), "heating_curve.default_name")}</div>
